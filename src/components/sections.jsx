...
export function Experience() {
  ...
  const items = [
    {
      period: '2024 — Present', badge: 'Current',
      role: 'Freelance Backend Engineer', company: 'Independent · Lagos, Nigeria',
      desc: 'Delivering backend solutions for clients in energy, fintech, and consumer software. Work ranges from procurement automation to real-time social applications.',
      achievements: [
        'Built Verdikt, a WebSocket-driven social polling game with a 66-question seed bank and live session management',
        'Automated electrical-sector procurement document processing, cutting manual work significantly',
        'Consulted on feasibility assessments for 14 project ideas with Nigerian market analysis',
      ],
      tech: ['Spring Boot', 'FastAPI', 'PostgreSQL', 'React'],
    },
    {
      period: '2024', badge: 'Internship',
      role: 'Backend Engineer', company: 'HNG Tech · Stage 9',
      desc: "Built a production-grade distributed job scheduler as part of HNG's competitive internship program.",
      achievements: [
        'Architected Dilamme Scheduler with priority queuing and real-time SSE updates',
        'Deployed with Nginx, DuckDNS, and HTTPS on a VPS with zero downtime',
        'Integrated Upstash Redis for distributed queue management',
      ],
      tech: ['FastAPI', 'MongoDB', 'Redis', 'SSE'],
    },
    {
      period: '2023 — 2024', badge: 'Mentorship',
      role: 'Engineering Mentor', company: 'Nigerian tech ecosystem · Lagos',
      desc: 'Mentoring emerging backend engineers on portfolio building, job applications, and professional engineering practice.',
      achievements: [
        'Guided developers through portfolio builds with modern UX and performance standards',
        'Supported junior engineers with interview prep and application strategy',
      ],
      tech: [],
    },
  ]
